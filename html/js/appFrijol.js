const appFrijol = new Vue({
    el: '#custom-tabs-frijol',
    data: {
        txtUnidad: 'txt_Unidad_Frijol_',
        txtCosto: 'txtCosto_Frijol_',
        decimales: 0,
        TasaInteresAnual: 0,
        isMobil: IS_MOBILE(),
        oValor: null,
        ...
        ObtenerCantidadesFile: async function(){
            ...
            try {
                ...
                .then(async data => {
                    ...
                    x.oValor = $.extend(true, {}, oValoresFromFileJson.Frijol);
